          ...
          <Show when={message()}>
            {(msg) => (
              ...
              >
                ...
                <Show when={msg().role === "user" && props.showUserActions}>
                  <div data-slot="session-turn-user-actions">
                    <Tooltip value="Search" placement="top" gutter={4}>
                      <IconButton
                        icon="magnifying-glass"
                        variant="ghost"
                        size="normal"
                        onClick={() => data.messageSearch?.({ sessionID: props.sessionID, messageID: msg().id })}
                        aria-label="Search"
                      />
                    </Tooltip>
                    <Tooltip value="Revert undo messages and file changes" placement="top" gutter={4}>
                      <IconButton
                        icon="arrow-down-to-line"
                        variant="ghost"
                        size="normal"
                        onClick={() => data.messageRevert?.({ sessionID: props.sessionID, messageID: msg().id })}
                        aria-label="Revert undo messages and file changes"
                      />
                    </Tooltip>
                    <Tooltip value={i18n.t("ui.message.copyMessage")} placement="top" gutter={4}>
                      <IconButton
                        icon="copy"
                        variant="ghost"
                        size="normal"
                        onClick={() => data.messageCopy?.({ sessionID: props.sessionID, messageID: msg().id })}
                        aria-label={i18n.t("ui.message.copyMessage")}
                      />
                    </Tooltip>
                    <Tooltip value="Fork" placement="top" gutter={4}>
                      <IconButton
                        icon="square-arrow-top-right"
                        variant="ghost"
                        size="normal"
                        onClick={() => data.messageFork?.({ sessionID: props.sessionID, messageID: msg().id })}
                        aria-label="Fork"
                      />
                    </Tooltip>
                  </div>
