...
const ProjectPreviewPanel = (props: {
  ...
  <div class="-m-1.5 p-1 flex flex-col w-72">
    ...
    <div class="px-0.5 pb-2 flex flex-col gap-2">
      <Show
          ...
          {(directory) => {
            ...
            return (
              <div class="flex flex-col gap-1">
                <div class="px-0.5 py-0.5 flex items-center gap-1 min-w-0">
    ...
    <div class="px-0.5 py-2 border-t border-border-weak-base">
      <Button
        variant="ghost"
        class="flex w-full text-left justify-start text-text-base px-0.5 hover:bg-transparent active:bg-transparent"
        onClick={() => {
