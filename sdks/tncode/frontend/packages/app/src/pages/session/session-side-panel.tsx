  ...
  return (
    <Show when={open()}>
      <aside
        ...
        class="relative min-w-0 h-full border-l border-border-weak-base flex session-side-panel"
        classList={{
          "flex-1": reviewOpen(),
          "shrink-0": !reviewOpen(),
        }}
          ...
          <div id="file-tree-panel" class="relative shrink-0 h-full" style={{ width: `${layout.fileTree.width()}px` }}>
            ...
            >
              <Tabs
                ...
                class="h-full session-filetree-shell"
                data-scope="filetree"
              >
                <Tabs.List>
                ...
                <Tabs.Content value="changes" class="px-3 py-0 session-filetree-content-changes">
                  <Switch>
                ...
                <Tabs.Content value="all" class="px-3 py-0 session-filetree-content-all">
                  <FileTree
                    path=""
                    modified={diffFiles()}
                    kinds={kinds()}
