...
export function SessionPromptDock(props: {
  ...
  return (
    <div
      ...
      class="session-prompt-shell shrink-0 w-full pb-3 flex flex-col justify-center items-center bg-background-stronger pointer-events-none"
    >
      <div
        classList={{
          "session-prompt-container w-full px-3 pointer-events-auto": true,
      ...
      >
        ...
        <Show when={!blocked()}>
          <Show
            when={prompt.ready()}
            fallback={
              <div class="session-prompt-loading w-full min-h-32 md:min-h-40 rounded-md border border-border-weak-base bg-background-base/50 px-4 py-3 text-text-weak whitespace-pre-wrap pointer-events-none">
          ...
          >
            <Show when={dock()}>
              <div
                classList={{
                  "transition-[max-height,opacity,transform] duration-[220ms] ease-out overflow-hidden": true,
                  "max-h-[320px]": !closing(),
            ...
            <div
              classList={{
                "relative z-10 session-prompt-input-wrap": true,
                "transition-[margin] duration-[220ms] ease-out": true,
                "-mt-9": dock() && !closing(),
                "mt-0": !dock() || closing(),
              }}
            >
